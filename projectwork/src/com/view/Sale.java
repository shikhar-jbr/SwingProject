...
String lg= JOptionPane.showInputDialog(null,"Logout? yes/no");
	...
	private JInternalFrame getInternalFrame() {
		if (internalFrame == null) {
			...
			internalFrame.setBounds(120, 153, 1029, 522);
	...
	private JScrollPane getScrollPane() {
		if (scrollPane == null) {
			...
			scrollPane.setBounds(81, 88, 865, 318);
	...
	private JLabel getLblNewLabel_7() {
		if (lblNewLabel_7 == null) {
			...
			lblNewLabel_7.setBounds(81, 435, 119, 26);
		}
	...
	private JTextField getTotaltxt() {
		if (Totaltxt == null) {
			...
			Totaltxt.setBounds(235, 435, 159, 26);
	...
	private JButton getBtnNewButton() {
		if (btnNewButton == null) {
			...
			btnNewButton.setBounds(771, 435, 98, 34);
		}
		return btnNewButton;
	}
